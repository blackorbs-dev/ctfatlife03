...
class CounterText extends ImplicitlyAnimatedWidget{
  const CounterText({Key? key, required this.count,
        Duration duration = const Duration(milliseconds: 2000),
        Curve curve = Curves.fastOutSlowIn, this.countStyle,
        this.prefix, this.prefixStyle, this.suffix, this.suffixStyle
      })
